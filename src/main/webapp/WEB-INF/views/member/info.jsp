...
$(function() {
	...
	var whichButton = "";
	var removeCheckModal = $("#remove-check-modal");
	...
	$("#member-info-input2, #member-info-input4").keyup(function() {
		...
		if ((pw1 != pw2)) {
			...
			if (pw1 == "") {
				modifyBtn.attr("disabled", "disabled");
				$("#member-info-password-message").text("패스워드가 입력해주세요.");
			} else {
...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			<form method="post" id="member-info-form1">
				...
				<div class="form-group">
					...
					<input value="${member.userName }" type="text" class="form-control" id="member-signup-input3" name="userName">
				</div>
...
<!-- 탈퇴 확인 모달 -->
<div class="modal" tabindex="-1" id="remove-check-modal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
